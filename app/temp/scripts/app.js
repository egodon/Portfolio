...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavBtn = function () {
	  function NavBtn() {
	    ...
	    this.navBtn = (0, _jquery2.default)(".nav-button");
	    this.navBtnExpand = (0, _jquery2.default)(".nav-button__expanded");
	    this.events();
	    this.hiddenBtn();
	  }
	  ...
	  _createClass(NavBtn, [{
	    ...
	    key: "hiddenBtn",
	    value: function hiddenBtn() {
	      var that = this;
	      var lastScrollTop = 0,
	          delta = 300,
	          scrollingDown = false;
	      (0, _jquery2.default)(window).scroll(function () {
	        var top = (0, _jquery2.default)(this).scrollTop();
